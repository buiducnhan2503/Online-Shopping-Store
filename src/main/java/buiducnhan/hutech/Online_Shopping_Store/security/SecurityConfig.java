package buiducnhan.hutech.Online_Shopping_Store.security;

import buiducnhan.hutech.Online_Shopping_Store.service.OAuthService;
    ...
    public SecurityFilterChain securityFilterChain(@NotNull HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/css/**", "/js/**", "/", "/oauth/**", "/users/register", "/error").permitAll()
                        .requestMatchers("/swagger-ui/**", "/v3/api-docs/**").permitAll()
                        .requestMatchers("/products/edit/**", "/products/add", "/products/delete").hasAnyAuthority("ADMIN")
                        .requestMatchers("/products", "/cart", "/cart/**", "/order/**").permitAll()
